...
export const BALANCE = {
  ...
  arena: {
    ...
    // ★戦闘中に見えるのは半径26mほどの床だけ。ここが空だと
    //   どれだけ外周を作り込んでも「何もない床」に見える
    decorCount: 60,      // 場内の構造物。当たり判定は持たない（見た目だけ）
  },
  ...
  camera: {
    ...
    refAspect: 1.6,
    near: 0.5,
    // ★結界の外に遠景の塔を置いたので、95 だと反対側の塔が途中で切れる。
    //   near が 0.5 のままなら深度精度への影響はほぼ無い
    far: 190,
  },
};
