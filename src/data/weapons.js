 ...
 *
 * ★見た目の基準は設定画の刀（黒い柄・深紅の柄巻き・金の鍔・明るい刃）。
 *   visual.model が形（src/scene/weaponShapes.js の WEAPON_MODELS）、
 *   visual.pal がその配色（WEAPON_PAL を上書き）。属性ごとに刃と巻きを振ってある。
 *   pal を省くと既定の「鋼の刃・深紅の巻き・金の鍔」になる。
 */
export const WEAPONS = [
  ...
  },
  {
    ...
    visual: { model: 'wand', color: 0x7fd4ff, emissive: 0x1a6aa0, scale: 1.0,
              pal: { blade: 0xb8e8ff, edge: 0xeafaff, wrap: 0x123f5c, guard: 0x9fc6d8, core: 0x5ad0ff } },
  ...
  },
  {
    ...
    visual: { model: 'axe', color: 0xff8a5c, emissive: 0x7a2a00, scale: 1.2,
              pal: { blade: 0xffb98a, edge: 0xffe8cc, wrap: 0x7a1a0e, guard: 0xd08a2a, core: 0xff5a1e } },
  ...
  // ─────────── SR ───────────
  {
    ...
    visual: { model: 'spear', color: 0x8be0ff, emissive: 0x2a7fd0, scale: 1.15,
              pal: { blade: 0xf4e89a, edge: 0xfffbe0, wrap: 0x4a3a0e, guard: 0xd8c040, core: 0xffe23a } },
  ...
  {
    id: 'wp_moon_naginata', name: '月薙', rarity: 'R', type: 'spear', element: 'none',
    base: { atk: 16, rate: 1.6, range: 4.4, crit: 0.08, critDmg: 0.7, knock: 0.55 },
    growth: { atk: 1.7 },
    // 間合いが長い代わりに遅い。近接なのに「距離で殴る」武器
    attack: { kind: 'melee_arc', arcDeg: 105, count: 1, pierce: 99, speed: 0, life: 0.22, radius: 0.75 },
    effects: [],
    visual: { model: 'naginata', color: 0xd8e2ee, emissive: 0x000000, scale: 1.1 },
    flavor: '間合いの外から首だけを持っていく。',
  },
  ...
  {
    id: 'wp_dragon_fang', name: '龍咬ノ大太刀', rarity: 'SSR', type: 'sword', element: 'none',
    base: { atk: 52, rate: 1.7, range: 4.1, crit: 0.26, critDmg: 1.25, knock: 0.85 },
    growth: { atk: 5.2 },
    attack: { kind: 'melee_arc', arcDeg: 160, count: 1, pierce: 99, speed: 0, life: 0.22, radius: 0.85 },
    effects: [{ id: 'explode', chance: 0.30, power: 0.9, radius: 3.4 }],
    visual: { model: 'greatsword', color: 0xe8ecf4, emissive: 0x000000, scale: 1.3,
              pal: { blade: 0xe2e8f2, edge: 0xffffff, wrap: 0x8e1522, guard: 0xd8a63c, core: 0xff2c3e } },
    flavor: '鍔に彫られた龍は、振るたび一度だけ牙を剥く。',
  },
  {
    ...
    visual: { model: 'naginata', color: 0xb8e8ff, emissive: 0x1f5c8a, scale: 1.2,
              pal: { blade: 0xb8e8ff, edge: 0xeafaff, wrap: 0x123f5c, guard: 0x9fc6d8, core: 0x5ad0ff } },
    flavor: '斬られたことに気づく頃には、傷が凍って血も出ない。',
  },
];
