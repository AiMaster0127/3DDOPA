...
> **現在の進捗：フェーズ4（ガチャ＆装備）完了 / フェーズ5（敵種・ボス・ステージ進行）着手待ち**
...
拠点でガチャを引き、装備を整え、アリーナで戦って育つ、というループが一周する。
**ボス・ステージ進行・拠点強化・演出の作り込みはまだ入っていない。**
...
### 検証結果（敵150体＋経験値ジェム・ランLv.8の最悪ケース）

| 項目 | 実測 | 予算 |
|---|---|---|
| `update()` | 16.7 µs / フレーム | — |
| `instances.sync()` | 13.1 µs / フレーム | — |
| **JSフレームコスト合計** | **0.031 ms** | 4 ms |
