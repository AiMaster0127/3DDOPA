...
- **PWA**：`manifest.webmanifest` + Service Worker。
  three.js を含む全62ファイルをプリキャッシュし、**完全オフラインで遊べる**
...
| 項目 | 実測 | 予算 |
|---|---|---|
| **JSフレームコスト合計** | **0.070 ms** | 4 ms |
| **600フレームのヒープ増加** | **0 KB**（増えない） | ループ内アロケーション0 |
| draw call | 14〜31 | 100 |
| 三角形数 | 2,426〜46,068 | 60,000 |
...
- `sw.js` が three.js を含む同梱ファイル全62点をプリキャッシュする
